...
//@ComponentScan
@MapperScan(basePackages = {"com.topjet.manage.mapper.writeMapper"},
...
//    private Class<? extends DataSource> dataSourceType=com.alibaba.druid.pool.DruidDataSource.class;
    ...
    @Primary
    public DataSourceTransactionManager transactionManager(@Qualifier("writedataSource") DataSource dataSource) throws Exception {
