...
<div class="contentBox" style="padding:10px; font-size:14px">
    <div class="fixed-table-toolbar">
        <div class="navmenu"><a href="#" onclick="javascript:history.back(-1); return false">企业认证审核</a> / 审核资料</div>
        ...
        <div  class="columns columns-left btn-group pull-left margin-right-10 fontsize-14">
            <input class="form-control input-sm pull-left" id="auditReason" style=" width:200px;" placeholder="审核原因"
...
<script type="text/javascript">
    ...
    function update() {
        ...
        var paras = {
            ...
            auditResultMsg:auditReason
        };

        var url = getRootPath() + '/companyAudit/updateCompany.do';
