        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                reader.onload = function(e){
                    ...
                    var pictureURL = {'pictureURL' : base64Str};
                    $.ajax({
                        type: "POST",
                        url : getRootPath() + '/marqueeAdvert/uploadPic.do',
                        data: JSON.stringify(pictureURL),
                        contentType:"application/json",
                        success: function(data){
                            if (data.success == "true") {
                                var param  = '{"name":"a.jpg", "originalName": "a.jpg", "size": "1", "state": "SUCCESS", "type": ".jpg", "url": "'+ data.pic +'"}';
                                me.uploadComplete(param);
                            }
                ...
                // alert(param );
                // // me.uploadComplete('{"name":"a.jpg", "originalName": "a.jpg", "size": "1", "state": "SUCCESS", "type": ".jpg", "url": "https://oivly1teo.qnssl.com/100601161202071720180312"}');
                // me.uploadComplete(param);
