...
icallcenter.hojotools.input = function(connectType) {
       ...
       msgObj.innerHTML = "<div style='text-align:right'>" +
       							...
       							"</a>" +
       						"</div>" +
       						"<div style='height:35px;overflow:hidden;text-align:center;margin-top: -5px;'>" +
...
icallcenter.hojotools.loading = function(message, parentId) {
	   ...
	   bgObj.style.top="0";
	   bgObj.style.background="none";
	   bgObj.style.filter="progid:DXImageTransform.Microsoft.Alpha(style=3,opacity=0,finishOpacity=75";
	   bgObj.style.opacity="0";
	   bgObj.style.left="0";
	   bgObj.style.width=sWidth + "px";
	   //bgObj.style.height=sHeight + "px";
       bgObj.style.height="50px";
	   bgObj.style.zIndex = "10000";
...
icallcenter.hojotools.error = function(message) {
    ...
    msgObj.style.lineHeight ="25px";
    msgObj.style.zIndex = "10001";
    msgObj.innerHTML = "<div style='height:27px;background: none;overflow:hidden;padding-top:10px;padding-right:10px;'><div style='float:right'><a href='javascript:icallcenter.hojotools.close();'><img src='../imgs/tinybox/close_1.gif' style='cursor: pointer;border:0px;' /></a></div></div>"+
        					"<div style='height:30px;overflow:hidden;margin-top:-30px;padding-left:20px;'><img src='../imgs/error.jpg' style='float:left;margin-top:4px;' /><div style='float:left;color:#666666;padding-left:5px;font-size:15px;padding-top:4px'>"+message+"</div></div>"+
        					"<div style='clear:both;height:1px;overflow:hidden'>&nbsp;</div>"+
        					"<div style='padding-left:240px;padding-top:20px;margin-top:-45px;margin-left: 120px'><a href='javascript:icallcenter.hojotools.close();'><img src='../imgs/confirm_1.jpg' onmouseover=\"this.src='../imgs/confirm_2.jpg'\" onmouseout=\"this.src='../imgs/confirm_1.jpg'\" style='cursor: pointer;border:0px;' /></a></div>";
