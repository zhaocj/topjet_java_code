(function(a) {
    ...
    i.prototype = {
        ...
        setDatesDisabled: function(j) {
            ...
            this.datesDisabled = f.map(this.datesDisabled,
                function(k) {
        ...
        setDaysOfWeekDisabled: function(j) {
            ...
            this.daysOfWeekDisabled = f.map(this.daysOfWeekDisabled,
                function(k) {
        ...
        setMinutesDisabled: function(j) {
            ...
            this.minutesDisabled = f.map(this.minutesDisabled,
                function(k) {
                    return parseInt(k, 10)
                });
            this.update();
        ...
        setHoursDisabled: function(j) {
            ...
            this.hoursDisabled = f.map(this.hoursDisabled,
                function(k) {
                    return parseInt(k, 10)
                });
            this.update();
    ...
    f.fn.datetimepicker = function(l) {
        ...
        this.each(function() {
            var o = f(this),
                ...
                m = typeof l == "object" && l;
            if (!n) {
                o.data("datetimepicker", (n = new i(this, f.extend({},
                    f.fn.datetimepicker.defaults, m))))
            }
    ...
    f(document).on("focus.datetimepicker.data-api click.datetimepicker.data-api", '[data-provide="datetimepicker"]',
        function(k) {
            var j = f(this);
