...
$("<div class=\"tabs-header\">"+"<div class=\"tabs-scroller-left glyphicon icon-double-angle-left\"></div>"+"<div class=\"tabs-scroller-right glyphicon icon-double-angle-right\"></div>"+"<div class=\"tabs-wrap\">"+"<ul class=\"tabs\"></ul>"+"</div>"+"</div>").prependTo(_31f);
...
$("　<a href=\"javascript:void(0)\" class=\"tabs-close icon-remove-circle\"></a>").appendTo(tab);
}else{
