...
public class CommonConstant {
    ...
    public static final String BONUS_MQ_ARTIFICAL = "topjet.order.bonus";

    public static final String SCORE_MQ_ARTIFICAL = "topjet.score.gain";

    public static final String BIRTHDAY_USER = "BIRTHDAY_USER_";
     ...
     * 积分
     */
    public static final String BLACK_LIST_TYPE_SOCRE = "4";
